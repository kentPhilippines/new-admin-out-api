...
public class Result<T> {
    ...
    @NotNull
    public static <K> Result<K> error(K data) {
        return new Result<>(CodeInfo.STATUS_CODE_ERROR.getCode(), CodeInfo.STATUS_CODE_ERROR.getMsg(), data);
    }
  ...
  /*  @NotNull
    @Contract("_ -> new")
    public static <K> Result<K> error(Integer code, String message) {
        return new Result<>(CodeInfo.STATUS_CODE_SUCCESS.getCode(), CodeInfo.STATUS_CODE_SUCCESS.getMsg());
    }*/
